...
def do_training(args, module, data_train, data_val, begin_epoch=0):
 ...
 #   summary_writer = SummaryWriter(tblog_dir)
    while True:
        ...
        curr_acc = val_cer
        log.info('CER validation %f at num_epoch: %d', val_cer, n_epoch)
        ...
        log.info('loss epoch %f at num_epoch %d', train_ctc_loss, n_epoch)
        log.info('CER train %f at num_epoch %d', train_cer, n_epoch)
