...
dataset_classes = {'mnist': 10, 'cifar10': 10, 'imagenet': 1000, 'dummy': 1000, 'caltech':256}
...
def get_data_iters(dataset, batch_size, num_workers=1, rank=0):
    ...
    if dataset == 'mnist':
        ...
        train_data, val_data = get_caltech256_iterator(opt.data_train, opt.data_val, (3,224,224), data_nthreads=24, batch_size=batch_size)
