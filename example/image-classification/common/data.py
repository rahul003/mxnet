...
def add_data_aug_args(parser):
    ...
    aug.add_argument('--min-random-scale', type=float, default=0.533,
...
def set_resnet_aug(aug):
    aug.set_defaults(random_crop=0, random_mirror=1, random_resized_crop=1)
    # others are set as default while defining the arugment  
